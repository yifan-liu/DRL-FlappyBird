...
class DQN:
    ...
    def create_network(self):
        ...
        # hidden layers
        h_conv1 = tf.nn.relu(self.conv2d(state_input,W_conv1,4) + b_conv1) # 【none,20,20,32]
        h_pool1 = self.max_pool_2x2(h_conv1) # [none,10,10,32]

        h_conv2 = tf.nn.relu(self.conv2d(h_pool1,W_conv2,2) + b_conv2) # [none,5,5,64]

        h_conv3 = tf.nn.relu(self.conv2d(h_conv2,W_conv3,1) + b_conv3) # [none,5,5,64]
